package com.internshala.quizzer;
...
public class QuestionsActivity extends AppCompatActivity {
    ...
    DatabaseReference myRef = database.getReferenceFromUrl("https://quizzer-73b15-default-rtdb.firebaseio.com");
    ...
    private boolean modelmatch(){
        ...
        for(QuestionModel model:bookmarksList){
            if(model.getQuestion().equals(list.get(position).getQuestion())&& model.getCorrectANS().equals(list.get(position).getCorrectANS())
